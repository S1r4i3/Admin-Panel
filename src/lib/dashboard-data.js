import { Bell, Bot, Briefcase, ChartSpline, CircleCheckBig, CreditCard, FileText, KeyRound, LayoutDashboard, LifeBuoy, Lock, Settings, Sparkles, Users, WalletCards, Webhook, } from "lucide-react";
...
export const formatCompactNumber = (value) => new Intl.NumberFormat("en-US", { notation: "compact", maximumFractionDigits: 1 }).format(value);
